...
public class Colors {
    public final static Color BLACK = Color.grayRgb(0);
    public final static Color BACKGROUND = Color.rgb(200, 200, 200);
    public final static Color FOREGROUND = Color.grayRgb(127);
    ...
    public final static Color FONT_BLACK = Color.rgb(20, 20, 20);
    public final static Color UI_BACKGROUND = Color.rgb(150, 150, 150, 0.9);
}
